...
def prepare(artifact: dict) -> dict:
    ...
    triage_strip = _triage_strip(verdicts_by_entity, n_total, entity_type_label)
...
def _entity_display(entity: str, entity_type: str) -> str:
    ...
    avoids that ambiguity. Other entity_types render as-is — the
    identifier is already self-evident in the column.
    """
    if not entity:
        return entity
