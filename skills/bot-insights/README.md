...
`docs/bot-insights-advanced-attribution-design.md`. They are design-direction
items, not current deterministic support. Until implemented, the current
supported attribution path remains the simple single-dimension
